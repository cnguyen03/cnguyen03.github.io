...
export default function Text({ label }: TextProps) {
    if (label === "about") {
        ...
        return <div className="font-lato text-xl my-8">
            ...
            <TypeAnimation sequence={[" a recent graduate 🎓!", 2000, " a software developer 💻!", 2000, "a coffee lover ☕!", 2000, "a gym go-er 🏋️!", 2000, "a basketball enjoyer 🏀!", 2000]} speed={50} deletionSpeed={75} repeat={Infinity} className="ml-1"></TypeAnimation>
            </div>
            <p>As a recent graduate from UC Irvine with a Bachelor's in Computer Science, I have a deep passion for {" "}<span className="font-bold">crafting software solutions and intelligent systems that make a tangible impact on people’s lives.</span> My academic background has provided me with a strong foundation in Computer Science fundamentals, which I have applied to solve real-world challenges.</p>
            <p className="my-2">
